# Run `homie-staging-live` In This Session
...
- Read file `./inputs/slack-staging-channel.md`
...
- Before sending `plan, parallel-report, package-diffs` to `judge-1`, confirm consent and apply redactions `.env, .env.*, secrets/**, **/*.key, **/secrets.auto.tfvars, **/facebook_state.json, **/slack.env, **/spaces.env`.
