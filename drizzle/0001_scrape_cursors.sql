CREATE TYPE "public"."ScrapeCursorStatus" AS ENUM('never', 'ok', 'auth', 'empty_suspect', 'parse', 'throttle', 'crash');--> statement-breakpoint
...
CREATE INDEX "scrape_cursors_last_status_idx" ON "scrape_cursors" USING btree ("lastStatus");
